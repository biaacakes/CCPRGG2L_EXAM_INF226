...
public class Regex {
    public static void main(String[] args) {
        ...
        // Provide the pattern
        pattern = Pattern.compile(".[^BTSbts].{5,}\\d$");
        ...
        pattern = Pattern.compile("[a-zA-Z46_.]{10,}@gmail.com");
        ...
        // Provide regex pattern
        pattern = Pattern.compile("(http?:\\/\\/)?([\\da-z\\/\\.-]+)");
        ...
        // Provide regex pattern
        pattern = Pattern
                .compile("\\w+(?=\\.pptx)|\\w\\w+(?=\\.xlsx)|\\w+(?=\\.docx)|\\w+(?=\\.txt)");
